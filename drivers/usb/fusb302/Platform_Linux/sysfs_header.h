...
#define LIST_OF_PE_STATES(STATE)\
    ...
    STATE(PE_BIST_Receive_Mode,          110),\
    STATE(PE_BIST_Frame_Received,        111),\
    STATE(PE_BIST_Carrier_Mode_2,        112),\
    STATE(PE_BIST_Test_Data,             113),\
    STATE(dbgGetRxPacket,                114),\
    STATE(dbgSendTxPacket,               115),\
